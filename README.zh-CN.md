...
DeskClaw 是人与 AI 共同经营组织的平台。通过智能助理（Cyber Workspace），人与 AI 在同一个数字空间中作为经营伙伴协同运转 -- 人类提供战略判断，AI 提供不懈的执行力，共同创造单方无法实现的价值。
...
- **智能助理**是共同经营的空间 -- 共享经营看板（黑板）、任务委派、实时协同，让人与 AI 的经营能力融为一体

## 核心概念

### 智能助理（Cyber Workspace）
...
- **智能助理** -- 六边形拓扑经营空间，人与 AI 共同经营、共享经营看板、委派业务
...
├── openclaw-channel-nodeskclaw/   # 智能助理经营通道插件
...
| [经营通道](openclaw-channel-nodeskclaw/README.md) | 智能助理通信基础设施 |
