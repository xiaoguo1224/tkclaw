...
import { Settings, Users, Dna, FolderOpen, Mail, Server, Building2, Container, ScrollText, GitBranch, Globe } from 'lucide-vue-next'
...
const allNavItems: NavItem[] = [
  ...
  { name: 'OrgDepartments', label: () => t('orgSettings.departments'), icon: GitBranch },
