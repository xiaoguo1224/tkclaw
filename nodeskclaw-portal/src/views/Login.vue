      ...
      <div class="w-full max-w-sm space-y-6">
        ...
        <div class="pt-4 text-center">
          <p class="text-[11px] text-muted-foreground/50">
            TClaw &copy; 2026 &middot; by <a href="https://nodesks.ai/" target="_blank" class="hover:text-muted-foreground transition-colors underline underline-offset-2">NoDesk AI</a>
          </p>
        </div>
      </div>
    </div>
